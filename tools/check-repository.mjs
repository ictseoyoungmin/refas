...
async function main() {
  const required = [
    ...
    'skills/refas/SKILL.md', 'skills/refas/references/parameter-fitting.md', 'skills/refas/scripts/refas.mjs', 'skills/refas/scripts/render_pbr.py', 'skills/refas/scripts/lib/index.mjs', 'skills/refas/scripts/lib/parameter-fit.mjs', 'skills/refas/scripts/lib/shape-repair.mjs', 'skills/refas/scripts/lib/camera-fit.mjs', 'skills/refas/scripts/lib/pose-fit.mjs', 'skills/refas/scripts/lib/geometry-backend.mjs', 'skills/refas/scripts/lib/perceptual-discrepancy.mjs', 'skills/refas/scripts/lib/appearance-fit.mjs', 'skills/refas/scripts/lib/macro-fit.mjs', 'skills/refas/scripts/lib/benchmark.mjs',
    'schemas/source-manifest.schema.json', 'schemas/checkpoint.schema.json', 'schemas/visual-review.schema.json', 'schemas/whole-object-certificate.schema.json', 'schemas/camera-fit.schema.json', 'schemas/pose-fit.schema.json', 'schemas/geometry-backend.schema.json', 'schemas/representation-capacity.schema.json', 'schemas/perceptual-discrepancy.schema.json', 'schemas/appearance-fit.schema.json', 'schemas/lighting-fit.schema.json', 'schemas/macro-fit.schema.json', 'schemas/benchmark-matrix.schema.json',
    'tests/contracts.test.mjs', 'tests/cli.test.mjs', 'tests/parameter-fit.test.mjs', 'tests/shape-repair.test.mjs', 'tests/governance.test.mjs', 'examples/wing-cover/run.mjs', 'examples/material-fixture/run.mjs', 'examples/hard-surface/run.mjs', 'examples/modular-assembly/run.mjs', 'examples/parameter-fit/run.mjs', 'examples/benchmark-matrix/run.mjs',
  ];
  const missing = [];
