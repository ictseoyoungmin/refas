...
async function main() {
  const required = [
    ...
    'tests/contracts.test.mjs', 'tests/canonical-edit-boundary.test.mjs', 'tests/attachment-semantics.test.mjs', 'tests/logical-fusion.test.mjs', 'tests/surface-anchor.test.mjs', 'tests/attachment-follow.test.mjs', 'tests/multi-anchor.test.mjs', 'tests/articulation-clearance.test.mjs', 'tests/attachment-propagation.test.mjs', 'tests/physical-fusion.test.mjs', 'tests/realized-contact.test.mjs', 'tests/constraint-aware-fit.test.mjs', 'tests/fit-structural-eligibility.test.mjs', 'tests/pose-fit-report-integrity.test.mjs', 'tests/cli.test.mjs', 'tests/parameter-fit.test.mjs', 'tests/shape-repair.test.mjs', 'tests/governance.test.mjs', 'examples/wing-cover/run.mjs', 'examples/material-fixture/run.mjs', 'examples/hard-surface/run.mjs', 'examples/modular-assembly/run.mjs', 'examples/parameter-fit/run.mjs', 'examples/benchmark-matrix/run.mjs',
  ];
  const missing = [];
