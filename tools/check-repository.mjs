...
const required = [
  ...
  '.github/labels.json','.github/pull_request_template.md','.github/scripts/sync-labels.mjs','.github/workflows/ci.yml','.github/workflows/sync-labels.yml',
...
async function main() {
  ...
  assert.equal(packageJson.version,'1.0.4','package version must be 1.0.4');
  ...
  assert.match(canonical,/REFAS_VERSION = '1\.0\.4'/u,'runtime version must match package version');
