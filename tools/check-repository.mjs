...
async function main() {
  const required = [
    ...
    '.github/workflows/ci.yml', '.github/workflows/sync-labels.yml', 'docs/github-governance.md', 'docs/canonical-edit-boundary.md', 'docs/attachment-semantics.md', 'docs/logical-fusion.md', 'docs/surface-anchor-frames.md', 'docs/attachment-follow.md', 'docs/multi-anchor-solver.md', 'docs/articulation-clearance.md',
    'skills/refas/SKILL.md', 'skills/refas/references/parameter-fitting.md', 'skills/refas/scripts/refas.mjs', 'skills/refas/scripts/render_pbr.py', 'skills/refas/scripts/lib/index.mjs', 'skills/refas/scripts/lib/canonical-edit.mjs', 'skills/refas/scripts/lib/attachment-semantics.mjs', 'skills/refas/scripts/lib/logical-fusion.mjs', 'skills/refas/scripts/lib/surface-anchor.mjs', 'skills/refas/scripts/lib/attachment-follow.mjs', 'skills/refas/scripts/lib/multi-anchor.mjs', 'skills/refas/scripts/lib/articulation-clearance.mjs', 'skills/refas/scripts/lib/parameter-fit.mjs', 'skills/refas/scripts/lib/shape-repair.mjs', 'skills/refas/scripts/lib/camera-fit.mjs', 'skills/refas/scripts/lib/pose-fit.mjs', 'skills/refas/scripts/lib/geometry-backend.mjs', 'skills/refas/scripts/lib/perceptual-discrepancy.mjs', 'skills/refas/scripts/lib/appearance-fit.mjs', 'skills/refas/scripts/lib/macro-fit.mjs', 'skills/refas/scripts/lib/benchmark.mjs',
    'schemas/source-manifest.schema.json', 'schemas/checkpoint.schema.json', 'schemas/visual-review.schema.json', 'schemas/whole-object-certificate.schema.json', 'schemas/canonical-edit-intent.schema.json', 'schemas/attachment-semantics.schema.json', 'schemas/logical-fusion.schema.json', 'schemas/logical-fusion-invalidation.schema.json', 'schemas/surface-anchor-set.schema.json', 'schemas/surface-anchor-rebind.schema.json', 'schemas/attachment-follow-state.schema.json', 'schemas/attachment-follow-report.schema.json', 'schemas/multi-anchor-plan.schema.json', 'schemas/multi-anchor-report.schema.json', 'schemas/articulated-joint.schema.json', 'schemas/articulated-joint-report.schema.json', 'schemas/supported-clearance.schema.json', 'schemas/supported-clearance-report.schema.json', 'schemas/camera-fit.schema.json', 'schemas/pose-fit.schema.json', 'schemas/geometry-backend.schema.json', 'schemas/representation-capacity.schema.json', 'schemas/perceptual-discrepancy.schema.json', 'schemas/appearance-fit.schema.json', 'schemas/lighting-fit.schema.json', 'schemas/macro-fit.schema.json', 'schemas/benchmark-matrix.schema.json',
    'tests/contracts.test.mjs', 'tests/canonical-edit-boundary.test.mjs', 'tests/attachment-semantics.test.mjs', 'tests/logical-fusion.test.mjs', 'tests/surface-anchor.test.mjs', 'tests/attachment-follow.test.mjs', 'tests/multi-anchor.test.mjs', 'tests/articulation-clearance.test.mjs', 'tests/cli.test.mjs', 'tests/parameter-fit.test.mjs', 'tests/shape-repair.test.mjs', 'tests/governance.test.mjs', 'examples/wing-cover/run.mjs', 'examples/material-fixture/run.mjs', 'examples/hard-surface/run.mjs', 'examples/modular-assembly/run.mjs', 'examples/parameter-fit/run.mjs', 'examples/benchmark-matrix/run.mjs',
  ];
  const missing = [];
