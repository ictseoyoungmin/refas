...
async function main() {
  const required = [
    ...
    '.github/workflows/ci.yml', '.github/workflows/sync-labels.yml', 'docs/github-governance.md', 'docs/canonical-edit-boundary.md', 'docs/attachment-semantics.md', 'docs/logical-fusion.md', 'docs/surface-anchor-frames.md', 'docs/attachment-follow.md', 'docs/multi-anchor-solver.md', 'docs/articulation-clearance.md', 'docs/attachment-propagation.md', 'docs/physical-fusion.md', 'docs/realized-contact-support.md', 'docs/constraint-aware-fitting.md', 'docs/candidate-transactions.md', 'docs/fitting-and-discrepancy.md',
    'skills/refas/SKILL.md', 'skills/refas/references/parameter-fitting.md', 'skills/refas/references/realized-contact-support.md', 'skills/refas/references/candidate-transactions.md', 'skills/refas/scripts/refas.mjs', 'skills/refas/scripts/render_pbr.py', 'skills/refas/scripts/lib/index.mjs', 'skills/refas/scripts/lib/canonical-edit.mjs', 'skills/refas/scripts/lib/attachment-semantics.mjs', 'skills/refas/scripts/lib/logical-fusion.mjs', 'skills/refas/scripts/lib/surface-anchor.mjs', 'skills/refas/scripts/lib/attachment-follow.mjs', 'skills/refas/scripts/lib/multi-anchor.mjs', 'skills/refas/scripts/lib/articulation-clearance.mjs', 'skills/refas/scripts/lib/attachment-propagation.mjs', 'skills/refas/scripts/lib/physical-fusion.mjs', 'skills/refas/scripts/lib/realized-contact.mjs', 'skills/refas/scripts/lib/fit-structural-eligibility.mjs', 'skills/refas/scripts/lib/candidate-transaction.mjs', 'skills/refas/scripts/lib/parameter-fit.mjs', 'skills/refas/scripts/lib/shape-repair.mjs', 'skills/refas/scripts/lib/camera-fit.mjs', 'skills/refas/scripts/lib/pose-fit.mjs', 'skills/refas/scripts/lib/orientation-evidence.mjs', 'skills/refas/scripts/lib/orientation-frame.mjs', 'skills/refas/scripts/lib/orientation-discrepancy.mjs', 'skills/refas/scripts/lib/orientation-pose-fit.mjs', 'skills/refas/scripts/lib/geometry-backend.mjs', 'skills/refas/scripts/lib/perceptual-discrepancy.mjs', 'skills/refas/scripts/lib/appearance-fit.mjs', 'skills/refas/scripts/lib/macro-fit.mjs', 'skills/refas/scripts/lib/benchmark.mjs',
  ...
  assert.equal(packageJson.version, '1.0.1', 'package version must be 1.0.1');
  const canonical = await fs.readFile(path.join(ROOT, 'skills/refas/scripts/lib/canonical.mjs'), 'utf8');
  assert.match(canonical, /REFAS_VERSION = '1\.0\.1'/u, 'runtime version must match package version');
  ...
  for (const contract of [
    ...
    'refas.camera-fit/v1',
    'refas.pose-fit/v1',
    'refas.orientation-evidence-set/v1',
    'refas.orientation-discrepancy/v1',
    'refas.geometry-backend/v1', 'refas.representation-capacity/v1',
